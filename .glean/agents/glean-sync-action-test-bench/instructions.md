...
## Transient preview verification (PR #8)

Draft previews should use a transient workflow id. The PR comment link must point to `/chat/agents/{previewId}/preview`, not `/edit`.
